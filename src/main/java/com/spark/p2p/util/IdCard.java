...
public class IdCard {
	...
	private static String parseNumberPart(String IDStr){
		String Ai="";
		// =======================(end)========================
		if (IDStr.length() == 18) {
	...
	public static String validate(String IDStr) {
		...
		String Ai = parseNumberPart(IDStr);
		// ================ 数字 除最后以为都为数字 ================
	...
	public static String parseBirthday(String idCard){
		String Ai = parseNumberPart(idCard);
		String strYear = Ai.substring(6, 10);// 年份
		String strMonth = Ai.substring(10, 12);// 月份
		String strDay = Ai.substring(12, 14);// 月份
	...
	public static String parseProvince(String idCard){
		return areaCode.get(idCard.substring(0, 2));
	}
