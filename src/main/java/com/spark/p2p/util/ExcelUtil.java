...
public class ExcelUtil {
	public static Workbook createMemberWorkBook(List<Map<String, String>> list, String[] keys, String columnNames[])
			throws Exception {
			...
			for (short j = 0; j < keys.length; j++) {
				...
				// 身份证正面
					...
					if (StringUtils.isNotBlank(cardImgAUrl)) {
						if (cardImgAUrl.startsWith("http")) {
							cell.setCellValue(cardImgAUrl);
						} else {
				...
				// 身份证反面
					...
					if (StringUtils.isNotBlank(cardImgBUrl)) {
						if (cardImgBUrl.startsWith("http")) {
							cell.setCellValue(cardImgBUrl);
						} else {
				...
				// 手持身份证
					...
					if (StringUtils.isNotBlank(handleImgUrl)) {
						...
						if (handleImgUrl.startsWith("http")) {
							cell.setCellValue(handleImgUrl);
						} else {
							cell.setCellValue(AppSetting.HOST_IP + handleImgUrl);
						}
					}
	...
	public static Workbook createAddressWorkBook(List<Map<String, String>> list, String[] keys, String columnNames[],
			String memberName) {
		Workbook wb = new HSSFWorkbook();
		Sheet sheet = wb.createSheet("sheet1");
		for (int i = 0; i < keys.length; i++) {
		...
		for (short i = 0; i < list.size(); i++) {
			...
			for (short j = 0; j < keys.length; j++) {
				...
				if (keys[j].equals("order_operation")) {
					cell.setCellValue(list.get(i).get(keys[j]).equals("7") ? "还款中" : "已完成");
		...
		for (short i = 0; i < list.size(); i++) {
			...
			for (short j = 0; j < keys.length; j++) {
				...
				if (keys[j].equals("payment_method")) {
					cell.setCellValue(list.get(i).get(keys[j]).equals("1") ? "微信" : "支付宝");
				} else {
					cell.setCellValue(list.get(i).get(keys[j]) == null ? " " : list.get(i).get(keys[j]).toString());
				}
				cell.setCellStyle(cs2);
	...
	public static Workbook createUrgeWorkBook(List<Map<String, String>> list, String[] keys, String columnNames[]) {
		Workbook wb = new HSSFWorkbook();
		Sheet sheet = wb.createSheet("sheet1");
		for (int i = 0; i < keys.length; i++) {
	...
	public static Workbook createShopWorkBook(List<Map<String, String>> list, String[] keys, String columnNames[]) {
		Workbook wb = new HSSFWorkbook();
		Sheet sheet = wb.createSheet("sheet1");
		for (int i = 0; i < keys.length; i++) {
			if (i == 0 || i == 5 || i == 2 || i == 6 || i == 7) {
	...
	public static Workbook createGoodsWorkBook(List<Map<String, String>> list, String[] keys, String columnNames[]) {
		Workbook wb = new HSSFWorkbook();
		Sheet sheet = wb.createSheet("sheet1");
		for (int i = 0; i < keys.length; i++) {
			if (i == 0 || i == 5 || i == 2 || i == 6 || i == 7) {
	...
	public static Workbook createCustomerWorkBook(List<Map<String, String>> list, String[] keys, String columnNames[]) {
		Workbook wb = new HSSFWorkbook();
		Sheet sheet = wb.createSheet("sheet1");
		for (int i = 0; i < keys.length; i++) {
			if (i == 0 || i == 5 || i == 2 || i == 6 || i == 7) {
	...
	public static Workbook createBrandWorkBook(List<Map<String, String>> list, String[] keys, String columnNames[]) {
		Workbook wb = new HSSFWorkbook();
		Sheet sheet = wb.createSheet("sheet1");
		for (int i = 0; i < keys.length; i++) {
			if (i == 0 || i == 5 || i == 2 || i == 6 || i == 7) {
	...
	public static Workbook createAuditSummaryWorkBook(List<Map<String, String>> list, String columnNames[]) {
		...
		if (list != null && list.size() > 0) {
			for (int i = 0; i < list.size(); i++) {
				...
				if (Convert.strToInt(map.get("order_operation"), 0) == 11
						|| Convert.strToInt(map.get("order_operation"), 0) == 12
						|| Convert.strToInt(map.get("order_operation"), 0) == 13) {
					if (map.get("clerk_other_opinion") == null) {
						...
						cell17.setCellValue(
								map.get("audit_time") + map.get("unpass_reason") + map.get("clerk_other_opinion"));
					}
				}
				if (Convert.strToInt(map.get("order_operation"), 0) == 2
						|| Convert.strToInt(map.get("order_operation"), 0) == 7
						|| Convert.strToInt(map.get("order_operation"), 0) == 8) {
					if (map.get("clerk_other_opinion") == null) {

						cell17.setCellValue(map.get("audit_time") + map.get("audit_opinion"));
					} else {
						cell17.setCellValue(
								map.get("audit_time") + map.get("audit_opinion") + map.get("clerk_other_opinion"));
					}
				}
				if (Convert.strToInt(map.get("order_operation"), 0) == 3) {
					if (map.get("clerk_other_opinion") == null) {
						...
						cell17.setCellValue(
								map.get("audit_time") + map.get("back_reason") + map.get("clerk_other_opinion"));
					}
				}
				if (Convert.strToInt(map.get("order_operation"), 0) == 0
						|| Convert.strToInt(map.get("order_operation"), 0) == 1) {
					if (map.get("clerk_other_opinion") == null) {
