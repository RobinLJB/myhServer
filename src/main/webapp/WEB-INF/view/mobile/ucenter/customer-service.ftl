	...
	<body>
		...
		<div class="mui-content wx-box " style="height: 100%; text-align: center;">
			<div class="wx-box-margin " style="background-color: #FFFFFF;">
				...
				<p style="white-space:nowrap; ">微信ID：<span style="color:#4E4E4E;-webkit-user-select: text;user-select:text;">xianjinqianbao2017</span></p>
				<p style="white-space:nowrap; margin-bottom: 20px;">加微信好友，和客服美眉私聊<img style="width: 10%;" src="${context}/asset/mobile/img/smile1.png" alt="" /></p>
				<img style="width: 80%;" src="${context}/asset/mobile/img/--.png" alt="" />
				<img style="width: 80%; margin: 0px 0;" src="${context}/asset/mobile/img/ewm.png" alt="" />
				<p>或<span style="color: #FA9F36;">微信扫一扫</span></p>
			</div>
			<p>客服电话-<span style="color:#373737;-webkit-user-select: text;user-select:text;">13023092809</span></p>
		</div>
	</body>
