...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		<li class=""><a href="${context}/admin/repay/alllist.html" aria-expanded="false">还款期间</a></li>
		<li class="active"><a href="${context}/admin/repay/repayComplete.html" aria-expanded="true">还款完成</a></li>
	</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/repay/repayComplete/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
