...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		...
		<li class="active"><a href="${context}/admin/borrow/borrowStatusFour.html" aria-expanded="true">初审成功</a></li>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/borrow/borrowStatusFour/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
				...
				
				{
					...
					"render":function(data,type,full){
						if(full.borrowStatus==2){return '<a class="btn btn-xs btn-default" href="${context}/admin/borrow/myClaim/fristAudit/'+data+'.html">初审</a>';}
							...
							return	'<a class="btn btn-xs btn-default" href="${context}/admin/borrow/myClaim/fristShow/'+data+'.html">查看</a>';
						}
