...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		<li class=""><a href="${context}/admin/borrow/loanBorrow.html" aria-expanded="true">等待终审</a></li>
		<li class="active"><a href="${context}/admin/borrow/loanBorrowFail.html" aria-expanded="false">终审失败</a></li>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/borrow/loanBorrowFail/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
