...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		<li class="active"><a href="${context}/admin/borrow/forSecondAudit.html" aria-expanded="true">等待复审</a></li>
		<li class=""><a href="${context}/admin/borrow/borrowStatusSeven.html" aria-expanded="false">复审失败</a></li>
		<li class=""><a href="${context}/admin/borrow/borrowStatussix.html" aria-expanded="true">复审成功</a></li>
		<#--<li class=""><a href="${context}/admin/borrow/borrowStatusBa.html" aria-expanded="false">放款成功</a></li>-->
	</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/borrow/forSecondAudit/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
			...
			"columnDefs":[
			...
			
				{
					...
					"data":'id',
					"render":function(data,type,full){
						if(full.borrowStatus==5){return '<a class="btn btn-xs btn-default" href="${context}/admin/borrow/forSecondAudit/'+data+'.html">复审</a><a class="btn btn-xs btn-default" href="${context}/admin/borrow/borrowAllStatueDetail/'+data+'.html">查看</a>';}
						else{
