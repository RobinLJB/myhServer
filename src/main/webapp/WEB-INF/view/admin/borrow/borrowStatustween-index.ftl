...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		...
		<li class=""><a href="${context}/admin/borrow/borrowStatusThree.html" aria-expanded="true">初审失败</a></li>
		<li class=""><a href="${context}/admin/borrow/borrowStatusFour.html" aria-expanded="false">初审成功</a></li>
		<li class="active"><a href="${context}/admin/borrow/borrowStatustween.html" aria-expanded="false">已取消</a></li>
	</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/borrow/borrowStatustween/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
