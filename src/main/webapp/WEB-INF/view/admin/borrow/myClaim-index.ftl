...
<div class="page-content">
	...
	<form class="form-inline" role="form">
		...
		<div class="form-group">
			<label for="control-label">申请额度</label>
			<select class="form-control"   data-toggle="table-search" data-column="3">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		<li class="active"><a href="${context}/admin/borrow/myClaimIndex.html" aria-expanded="true">等待审核</a></li>
		<li class=""><a href="${context}/admin/borrow/borrowStatusThree.html" aria-expanded="false">初审失败</a></li>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/borrow/myClaim/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
