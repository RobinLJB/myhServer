...
<div class="page-content">
    ...
    <ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
        <li class="active"><a href="${context}/admin/borrow/loanBorrow.html" aria-expanded="true">等待终审</a></li>
        <li class=""><a href="${context}/admin/borrow/loanBorrowFail.html" aria-expanded="false">终审失败</a></li>
        <li class=""><a href="${context}/admin/borrow/loanBorrowSuccess.html" aria-expanded="false">放款成功</a></li>
    </ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/borrow/forFinalAudit/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
			...
			"columnDefs":[
				...
				
				{
					...
					"render":function(data,type,full){
						if(data == 1){
                            ...
                            return '<span class="label label-success">终审失败</span>';
                        }
			...
			
				{
					...
					"data":'id',
					"render":function(data,type,full){
						if(full.borrowStatus==6){return '<a class="btn btn-xs btn-default" href="${context}/admin/borrow/forFinalAudit/'+data+'.html">放款审核</a><a class="btn btn-xs btn-default" href="${context}/admin/borrow/borrowAllStatueDetail/'+data+'.html">查看</a>';}
						else{
