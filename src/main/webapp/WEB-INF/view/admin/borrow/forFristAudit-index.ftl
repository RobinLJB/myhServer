...
<div class="page-content">
	<div class="page-bar">
		<ul class="page-breadcrumb">
			<li>
				...
				<a href="${context}/admin/borrow/forFristAudit.html">借款列表</a>
				<i class="fa fa-angle-right"></i>
			</li>
			<li>
				<a href="${context}/admin/borrow/forFristAudit.html">所有借款</a>
			</li>
		</ul>
	...
	<form class="form-inline" role="form">
		...
		<div class="form-group">
			...
			<select class="form-control"   data-toggle="table-search" data-column="10">
				<option  value="">全部</option>
				<option  value="1">提交审核</option>
				<option  value="2">已认领</option>
				<option  value="3">初审失败</option>
				<option  value="4">初审成功</option>
				<option  value="5">等待复审</option>
				<option  value="6">复审成功</option>
				<option  value="7">复审失败</option>
				<option  value="8">还款期间</option>
				<option  value="9">已经逾期</option>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/borrow/forFristAudit/list.json',{
			"pageLength": 100,
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
			...
			"columnDefs":[
				...
				},
				{
					...
					"render":function(data,type,full){
						if(data == "" || data == null){
							if(full.borrowStatus>=6 && full.borrowStatus!=12){
								return  '自动审核';
							}else{
								return  data;
							}
				...
				},
				{
					...
					"data":'id',
					"render":function(data,type,full){
						if(full.borrowStatus==1){return '<a class="btn btn-xs btn-default" href="${context}/admin/borrow/toMyClaim/'+data+'.html">认领</a><a class="btn btn-xs btn-default" href="${context}/admin/borrow/borrowAllStatueDetail/'+data+'.html">查看</a>';}
						else if(full.borrowStatus==5){
						return	'<a class="btn btn-xs btn-default" href="${context}/admin/borrow/forSecondAudit/'+data+'.html">复审</a><a class="btn btn-xs btn-default" href="${context}/admin/borrow/borrowAllStatueDetail/'+data+'.html">查看</a>';
						}else{
							return	'<a class="btn btn-xs btn-default" href="${context}/admin/borrow/borrowAllStatueDetail/'+data+'.html">查看</a>';
						}
