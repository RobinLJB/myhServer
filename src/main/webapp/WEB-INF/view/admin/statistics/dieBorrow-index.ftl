...
<@override name="body">
<input type="hidden" id="MENU_ACTIVE_ID" value="statistics:dieBorrow" />
<div class="page-content">
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="${context}/admin/borrow/forFristAudit.html">死账统计</a>
			</li>
		</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/dieBorrow/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name"},
				{ "data": "mobilePhone" },
			...
			"columnDefs":[
			{
				...
				
				{
					...
					"render":function(data,type,full){
						...
						else return  '<span class="label label-danger">死账</span>';
					}
				}
			],
