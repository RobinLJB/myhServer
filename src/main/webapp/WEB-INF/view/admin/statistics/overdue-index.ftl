...
<@override name="body">
<input type="hidden" id="MENU_ACTIVE_ID" value="statistics:overdue" />
<div class="page-content">
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="${context}/admin/borrow/forFristAudit.html">逾期统计</a>
			</li>
		</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/overdue/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name"},
				{ "data": "mobilePhone" },
			...
			"columnDefs":[
			{
				...
				
				{
					...
					"render":function(data,type,full){
						if(data == 1){
							 return  '<span class="label label-info">未催收</span>';
						}else if(data == 2) return  '<span class="label label-info">已催收未还款</span>';
						else if(data == 3) return  '<span class="label label-success">已还款</span>';
						else if(data == 4) return  '<span class="label label-success">死账</span>';
						else return  '<span class="label label-danger">未分配</span>';
					}
				}
			],
