...
<@override name="body">
<input type="hidden" id="MENU_ACTIVE_ID" value="statistics:fristAuditFail" />
<div class="page-content">
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="${context}/admin/borrow/forFristAudit.html">初审统计</a>
			</li>
		</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/fristAuditFail/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name"},
				{ "data": "mobilePhone" },
