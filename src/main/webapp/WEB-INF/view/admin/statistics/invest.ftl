...
<@override name="body">
<input type="hidden" id="MENU_ACTIVE_ID" value="statistics:invest" />
<div class="page-content">
	...
	<div class="portlet light">
		...
		<div class="portlet-body">
			<div style="height:400px" id="dailyInvestChart"></div>
			<hr/>
			<div style="height:400px"  id="totalInvestChart"></div>
		</div>
	</div>
</div>
</@override>
...
function renderChart(){
	...
	$.ajax({
		url:'${context}/admin/statistics/invest/data.do',
		data:data,
		success:function(resp){
			AmCharts.makeChart("dailyInvestChart", {
			    "type": "serial",
			    "theme": "light",
			    "marginTop":10,
			    "marginRight": 80, 
			    ...
			    },
			    {
			    	...
			    	"valueAxis":"countAxis",
			        "id":"g2",
			        "balloonText": "[[value]] 人次",
			        "bullet": "round",
			        "bulletSize": 8,
			        //"lineColor": "#1caf9a",
			        //"lineThickness": 1,
			        //"type": "smoothedLine",
			        "valueField": "invest_count"
			    },
			     {
			    	"title":"投资人数(人)",
			    	"valueAxis":"countAxis",
			        "id":"g3",
			        "balloonText": "[[value]] 人数",
			        "bullet": "round",
			        "bulletSize": 8,
			        //"lineColor": "#1caf9a",
			        //"lineThickness": 1,
			        //"type": "smoothedLine",
			        "valueField": "investor_count"
			    }
			    ],
			...
			var chart = AmCharts.makeChart("totalInvestChart", {
			    "type": "serial",
			    "theme": "light",
			    "path":"${context}/asset/public/plugins/amcharts/amcharts/",
			    "marginTop":10,
			    ...
			    "graphs": [{
			        ...
			        "lineThickness": 2,
			        "type": "smoothedLine",
			        "valueField": "total_invest_amount"
			    }
			    ],
