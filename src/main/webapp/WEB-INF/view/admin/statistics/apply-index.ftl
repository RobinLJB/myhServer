...
<div class="page-content">
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="${context}/admin/borrow/forFristAudit.html">申请统计</a>
			</li>
		</ul>
	...
	<form class="form-inline" role="form">
		...
		<div class="form-group">
			...
			<select class="form-control"   data-toggle="table-search" data-column="7">
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/apply/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name"},
				{ "data": "mobilePhone" },
