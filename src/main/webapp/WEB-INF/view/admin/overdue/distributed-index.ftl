...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		<li class=""><a href="${context}/admin/overdue/distribution.html" aria-expanded="true">等待分配</a></li>
		<li class="active"><a href="${context}/admin/overdue/distributed.html" aria-expanded="false">已分配</a></li>
	</ul>
		...
		var table = spark.dataTable('#memberTable','${context}/admin/overdue/distributed/list.json',{
			...
			"columnDefs":[
				...
				},
				{
					...
					"data":'id',
					"render":function(data,type,full){
						return	'<a class="btn btn-xs btn-default" href="${context}/admin/overdue/distributeds/'+data+'.html">查看</a>';
					}
				}
			],
