...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		...
		<li class=""><a href="${context}/admin/overdue/pressedAlreadyepay.html" aria-expanded="false">催收已还款</a></li>
		<li class="active"><a href="${context}/admin/overdue/pressedDieaBorrow.html" aria-expanded="false">死账</a></li>
	</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/overdue/pressedDieaBorrow/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "benJin" },
			...
			"columnDefs":[
				...
				},
				{
					...
					"data":'id',
					"render":function(data,type,full){
						return	'<a class="btn btn-xs btn-default" href="${context}/admin/overdue/pressedDieaBorrow/'+data+'.html">催收</a>';
