...
<input type="hidden" id="status" value="${status!1}" />
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		<li id="a" class="active"><a href="${context}/admin/overdue/mymanager.html?status=1" aria-expanded="true">等待催收</a></li>
		<li id="b" class=""><a href="${context}/admin/overdue/pressedUnrepay.html" aria-expanded="false">已催收未还款</a></li>
		<li id="c" class=""><a href="${context}/admin/overdue/pressedAlreadyepay.html" aria-expanded="false">催收已还款</a></li>
		<li id="d" class=""><a href="${context}/admin/overdue/pressedDieaBorrow.html" aria-expanded="false">死账</a></li>
	</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/overdue/distributedToMe/list/${status}.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "benJin" },
			...
			"columnDefs":[
				...
				},
				{
					...
					"data":'id',
					"render":function(data,type,full){
						return	'<a class="btn btn-xs btn-default" href="${context}/admin/overdue/distributedToMe/'+full.borrowId+'.html">催收</a>';
