...
<div class="page-content">
    ...
    <table class="table detail-info">
        ...
        <#--<td><#if member?? && member.callStatus=='1'><a href="${context}/admin/member/callDetail/${member.id?c}.html">查看运营商信息</a><#else>没有运营商信息</#if></td>-->
            <td><#if member.taskId??><a href="https://portal.shujumohe.com/nolayout/customerReport/${member.taskId}"
                                        target="_blank">查看运营商信息</a><#else>没有运营商信息</#if></td>
            <th>通讯录</th>
            <td>
            ...
            <tr>
                <#if pressList??>
                    ...
                    <tr>
                        <td>${lists_index+1}</td>
                        <td>
                            <#if lists.phoneCall=="1">已沟通<#else>未沟通</#if>
                        </td>
                        <td>
                            <#if lists.repayStatus=="1">已还款<#elseif lists.repayStatus=="2">未还款<#else>死账</#if>
                        </td>
                        <td>${lists.pressTime!}</td>
                        <td style="width:277px;height:auto">${lists.review!}</td>
                    </tr>
                    </#list>
                <#else>
                <tr>
