...
<@override name="body">
<input type="hidden" id="MENU_ACTIVE_ID" value="repayment:lately" />
<div class="page-content">
	...
	<div class="tabbable-line" style="margin-bottom: 15px">
		<ul class="nav nav-tabs">
			<li <#if currDay == 3>class="active"</#if>>
				<a href="${context}/admin/repayment/lately.html?day=3">最近3天</a>
			</li>
			<li <#if currDay == 7>class="active"</#if>>
				<a href="${context}/admin/repayment/lately.html?day=7">最近7天</a>
			</li>
			<li <#if currDay == 15>class="active"</#if>>
				<a href="${context}/admin/repayment/lately.html?day=15">最近15天</a>
			</li>
		</ul>
	</div>
	<form class="form-inline" role="form">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" data-toggle="table-search" data-column="2"   placeholder="申请人">
		</div>
...
<script>
	$(document).ready(function() {
	    var index = 0;
		var table = spark.dataTable('#loanTable','${context}/admin/repayment/list/lately/3.json',{
		  //向服务器传额外的参数
			"columns": [
				{ "data": "id" },
				{ "data": "realName" },
