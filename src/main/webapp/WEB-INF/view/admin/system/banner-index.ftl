...
<div class="page-content">
    ...
    <table class="table detail-info">
        ...
        <tr>
            ...
            <td>
                <button type="button" id="uploadImg" class="btn btn-primary btn-xs" data-btn-type="selectIcon">
...
<script>
    ...
    function audit(status) {
        ...
        $.post('${context}/admin/borrow/secondAudit/updateStatus.do', param, function (resp) {
            ...
            if (resp.code == 0) {
                spark.notify('复审通过');
                //spark.redirect('${context}/admin/borrow/borrowStatusBa.html');
            } else if (resp.code == -2) {
                spark.notify(resp.message, 'error');
                //spark.redirect('${context}/admin/borrow/borrowStatusSeven.html');
            } else {
                spark.notify(resp.message, 'error');
