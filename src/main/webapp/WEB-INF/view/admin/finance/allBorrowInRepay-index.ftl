...
<@override name="body">
<input type="hidden" id="MENU_ACTIVE_ID" value="funds:allBorrowInRepay" />
<div class="page-content">
	...
	<div class="alert alert-info" style="margin-top:20px;">
		<p>正在还款总额：${benjin!0}元   &nbsp;&nbsp;正在放款次数：${count!0}次</p>
	</div>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/funds/allBorrowInRepay/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
				{ "data": "benJin" },
				{ "data": "borrowDate" },
				{ "data": "fristSubmitTime" },{ "data": "secondAuditTime" },
			...
			"columnDefs":[
				...
				},
				{
					...
					"data":'id',
					"render":function(data,type,full){
						if(full.borrowStatus==5){return '<a class="btn btn-xs btn-default" href="${context}/admin/borrow/forSecondAudit/'+data+'.html">复审</a><a class="btn btn-xs btn-default" href="${context}/admin/member/'+data+'.html">查看</a>';}
						else{
							return	'<a class="btn btn-xs btn-default" href="${context}/admin/member/'+data+'.html">查看</a>';
						}
