...
<@override name="body">
<input type="hidden" id="MENU_ACTIVE_ID" value="funds:allBorrow" />
<div class="page-content">
	...
	<div class="alert alert-info" style="margin-top:20px;">
		<p>平台累计放款：${benjin!0}元   &nbsp;&nbsp;累计放款次数：${count!0}次</p>
	</div>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/funds/allBorrow/list.json',{
			"columns": [
				{ "data": "id" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
