...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		<li class="active"><a href="${context}/admin/extension/subPersonA/${mid}.html" aria-expanded="true">已提交申请</a></li>
		<li class=""><a href="${context}/admin/extension/subPersonB/${mid}.html" aria-expanded="false">已放款的</a></li>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/extension/subPersonA/list/${mid}.json',{
			"columns": [
				{ "data": "bid" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
