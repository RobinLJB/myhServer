...
<div class="page-content">
	...
	<ul class="nav nav-tabs"     style="margin-bottom: 0px;border-bottom: 0px solid #ddd;" >
		...
		<li class="active"><a href="${context}/admin/extension/subPersonC/${mid}.html" aria-expanded="true">已拒绝</a></li>
	</ul>
...
<script>
	$(document).ready(function() {
		var table = spark.dataTable('#memberTable','${context}/admin/extension/subPersonC/list/${mid}.json',{
			"columns": [
				{ "data": "bid" },
				{ "data": "real_name" },
				{ "data": "mobilePhone" },
